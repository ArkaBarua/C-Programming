...
{
    int m = 20, n = 30, sum;
    sum = add(m, n);            // while calling a function don't mention the return type of the function
                                // also don't mention the data types of the arguments
    printf("sum is %d\n", sum); // sum = 50
    return 0;
}
// definiton of a function
int add(int a, int b)
{                   // need to provied the return type of function and data types
